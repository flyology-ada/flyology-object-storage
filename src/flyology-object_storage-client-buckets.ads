...
--  BEGIN S3 OPERATION GENERATOR: BUCKETS_CONTEXT
...
--  END S3 OPERATION GENERATOR: BUCKETS_CONTEXT
...
--  BEGIN S3 OPERATION GENERATOR: BUCKETS_VISIBLE
--  Generated by tools/s3-operation.py; do not edit this region.

   --  Shape of a terminal ListDirectoryBuckets read.
   ...
   --  Shape of one terminal CreateBucketMetadataConfiguration call.
   --  @enum Create_Bucket_Metadata_Configuration_Response_Available A complete
   --  modeled response exists
   --  @enum Create_Bucket_Metadata_Configuration_Exchange_Failed No complete
   --  modeled response exists
   type Create_Bucket_Metadata_Configuration_Result_Kind is
     (Create_Bucket_Metadata_Configuration_Response_Available,
      Create_Bucket_Metadata_Configuration_Exchange_Failed);

   --  Typed bucket metadata configuration replacement result. The defaults are
   --  conservative initialization sentinels shared by sibling mutation
   --  results; Finish replaces them with terminal evidence before exposing the
   --  value.
   --  @field Kind Result shape
   --  @field Disposition Mutation certainty
   --  @field Failure Bounded expected failure reason
   ...
   --  @field HTTP_Phase Causal HTTP phase
   --  @field Detail Bounded sanitized HTTP diagnostic
   type Create_Bucket_Metadata_Configuration_Result
     (Kind : Create_Bucket_Metadata_Configuration_Result_Kind :=
        Create_Bucket_Metadata_Configuration_Exchange_Failed)
   is record
      ...
      Admission : Flyology.HTTP.Client.Admission_Certainty :=
        Flyology.HTTP.Client.Not_Admitted;
      case Kind is
         when Create_Bucket_Metadata_Configuration_Response_Available =>
            Response : Low_Level.Put_Bucket_Control_Outcome;
         when Create_Bucket_Metadata_Configuration_Exchange_Failed =>
            HTTP_Result : Flyology.HTTP.Client.Exchange_Result_Kind :=
              Flyology.HTTP.Client.Response_Invalid;
            HTTP_Phase : Flyology.HTTP.Client.Exchange_Phase :=
              Flyology.HTTP.Client.Not_Started;
   ...
   --  One-shot owner-driven bucket metadata configuration replacement. The
   --  exact serialized body remains owned through typed Finish and is never
   --  replayed.
   type Create_Bucket_Metadata_Configuration_Operation
     (Set          : not null access Flyology.Operations.Completion_Set'Class;
      HTTP         : not null access Flyology.HTTP.Client.Client;
      Cancellation : access Flyology.Cancellation.Token) is
     new Flyology.Operations.Operation
   ...
   --  Start or restart one bucket metadata configuration replacement.
   ...
   --  Construct one owner-driven bucket metadata configuration replacement.
   --  @param Set Caller-owned completion set
   --  @param Client HTTP client retained through terminal drain
   --  @param Origin Exact HTTP origin used for routing and signing
   --  @param Bucket Required exact target bucket
   ...
   --  @param Limits Caller-selected bounded XML limits
   --  @param Token Optional cancellation source retained to drain
   --  @return Started owner-driven bucket metadata configuration replacement
   function Create_Metadata_Configuration
     (Set        : not null access Flyology.Operations.Completion_Set'Class;
      ...
      Limits     : S3.XML.Parse_Limits;
      Token      : access Flyology.Cancellation.Token)
      return Create_Bucket_Metadata_Configuration_Operation;

   --  Consume one terminal CreateBucketMetadataConfiguration operation.
   --  @param Operation Terminal owner-driven operation consumed
   --  @param Result Complete typed terminal evidence
   procedure Finish
     (Operation : in out Create_Bucket_Metadata_Configuration_Operation;
      Result    : out Create_Bucket_Metadata_Configuration_Result)
   with Pre => Flyology.Operations.Is_Terminal (Operation);

   --  Replace one bucket metadata configuration by waiting on the same state
   --  machine used by composable callers. No possibly admitted request is
   --  replayed; unknown outcomes require read-only Get_Metadata_Configuration
   --  reconciliation.
   --  @param Client HTTP client retained through terminal drain
   --  @param Origin Exact HTTP origin used for routing and signing
   --  @param Bucket Required exact target bucket
   ...
   --  @param Token Caller-selected cancellation source or null
   --  @param Limits Caller-selected bounded XML limits
   --  @return Terminal typed bucket metadata configuration replacement
   --  evidence
   function Create_Metadata_Configuration
     (Client     : aliased in out Flyology.HTTP.Client.Client;
      Origin     : Flyology.HTTP.Origin;
   ...
   --  Shape of one terminal UpdateBucketMetadataInventoryTableConfiguration
   --  call.
   --  @enum Set_Metadata_Inventory_Table_Configuration_Response_Available A
   --  complete modeled response exists
   --  @enum Set_Metadata_Inventory_Table_Configuration_Exchange_Failed No
   --  complete modeled response exists
   type Set_Metadata_Inventory_Table_Configuration_Result_Kind is
     (Set_Metadata_Inventory_Table_Configuration_Response_Available,
      Set_Metadata_Inventory_Table_Configuration_Exchange_Failed);

   --  Typed metadata inventory-table configuration replacement result. The
   ...
   --  @field HTTP_Phase Causal HTTP phase
   --  @field Detail Bounded sanitized HTTP diagnostic
   type Set_Metadata_Inventory_Table_Configuration_Result
     (Kind : Set_Metadata_Inventory_Table_Configuration_Result_Kind :=
        Set_Metadata_Inventory_Table_Configuration_Exchange_Failed)
   is record
      Disposition : Bucket_Metadata_Configuration_Mutation_Disposition :=
        Bucket_Metadata_Configuration_Mutation_Outcome_Unknown;
      ...
      Admission : Flyology.HTTP.Client.Admission_Certainty :=
        Flyology.HTTP.Client.Not_Admitted;
      case Kind is
         when Set_Metadata_Inventory_Table_Configuration_Response_Available =>
            Response : Low_Level.Put_Bucket_Control_Outcome;
         when Set_Metadata_Inventory_Table_Configuration_Exchange_Failed =>
            HTTP_Result : Flyology.HTTP.Client.Exchange_Result_Kind :=
              Flyology.HTTP.Client.Response_Invalid;
            HTTP_Phase : Flyology.HTTP.Client.Exchange_Phase :=
              Flyology.HTTP.Client.Not_Started;
   ...
   --  One-shot owner-driven metadata inventory-table configuration
   --  replacement. The exact serialized body remains owned through typed
   --  Finish and is never replayed.
   type Set_Metadata_Inventory_Table_Configuration_Operation
     (Set          : not null access Flyology.Operations.Completion_Set'Class;
      HTTP         : not null access Flyology.HTTP.Client.Client;
      Cancellation : access Flyology.Cancellation.Token) is
     new Flyology.Operations.Operation
   ...
   --  Start or restart one metadata inventory-table configuration replacement.
   --  Operation is last so overload resolution preserves the provider-centric
   --  vocabulary.
   --  @param Client HTTP client retained through terminal drain
   --  @param Origin Exact HTTP origin used for routing and signing
   ...
   --  Construct one owner-driven metadata inventory-table configuration
   --  replacement.
   --  @param Set Caller-owned completion set
   --  @param Client HTTP client retained through terminal drain
   --  @param Origin Exact HTTP origin used for routing and signing
   ...
   --  @param Limits Caller-selected bounded XML limits
   --  @param Token Optional cancellation source retained to drain
   --  @return Started owner-driven metadata inventory-table configuration
   --  replacement
   function Set_Metadata_Inventory_Table_Configuration
     (Set        : not null access Flyology.Operations.Completion_Set'Class;
      ...
      Limits     : S3.XML.Parse_Limits;
      Token      : access Flyology.Cancellation.Token)
      return Set_Metadata_Inventory_Table_Configuration_Operation;

   --  Consume one terminal UpdateBucketMetadataInventoryTableConfiguration
   --  operation.
   --  @param Operation Terminal owner-driven operation consumed
   --  @param Result Complete typed terminal evidence
   procedure Finish
     (Operation : in out Set_Metadata_Inventory_Table_Configuration_Operation;
      Result    : out Set_Metadata_Inventory_Table_Configuration_Result)
   with Pre => Flyology.Operations.Is_Terminal (Operation);

   --  Replace one metadata inventory-table configuration by waiting on the
   --  same state machine used by composable callers. No possibly admitted
   --  request is replayed; unknown outcomes require read-only
   ...
   --  @param Token Caller-selected cancellation source or null
   --  @param Limits Caller-selected bounded XML limits
   --  @return Terminal typed metadata inventory-table configuration
   ...
   --  Shape of one terminal UpdateBucketMetadataAnnotationTableConfiguration
   --  call.
   --  @enum Set_Metadata_Annotation_Table_Configuration_Response_Available A
   --  complete modeled response exists
   --  @enum Set_Metadata_Annotation_Table_Configuration_Exchange_Failed No
   --  complete modeled response exists
   type Set_Metadata_Annotation_Table_Configuration_Result_Kind is
     (Set_Metadata_Annotation_Table_Configuration_Response_Available,
      Set_Metadata_Annotation_Table_Configuration_Exchange_Failed);

   --  Typed metadata annotation-table configuration replacement result. The
   --  defaults are conservative initialization sentinels shared by sibling
   --  mutation results; Finish replaces them with terminal evidence before
   --  exposing the value.
   --  @field Kind Result shape
   ...
   --  @field HTTP_Phase Causal HTTP phase
   --  @field Detail Bounded sanitized HTTP diagnostic
   type Set_Metadata_Annotation_Table_Configuration_Result
     (Kind : Set_Metadata_Annotation_Table_Configuration_Result_Kind :=
        Set_Metadata_Annotation_Table_Configuration_Exchange_Failed)
   is record
      Disposition : Bucket_Metadata_Configuration_Mutation_Disposition :=
        Bucket_Metadata_Configuration_Mutation_Outcome_Unknown;
      ...
      Admission : Flyology.HTTP.Client.Admission_Certainty :=
        Flyology.HTTP.Client.Not_Admitted;
      case Kind is
         when Set_Metadata_Annotation_Table_Configuration_Response_Available =>
            Response : Low_Level.Put_Bucket_Control_Outcome;
         when Set_Metadata_Annotation_Table_Configuration_Exchange_Failed =>
            HTTP_Result : Flyology.HTTP.Client.Exchange_Result_Kind :=
              Flyology.HTTP.Client.Response_Invalid;
            HTTP_Phase : Flyology.HTTP.Client.Exchange_Phase :=
              Flyology.HTTP.Client.Not_Started;
   ...
   --  One-shot owner-driven metadata annotation-table configuration
   --  replacement. The exact serialized body remains owned through typed
   --  Finish and is never replayed.
   type Set_Metadata_Annotation_Table_Configuration_Operation
     (Set          : not null access Flyology.Operations.Completion_Set'Class;
      HTTP         : not null access Flyology.HTTP.Client.Client;
      Cancellation : access Flyology.Cancellation.Token) is
     new Flyology.Operations.Operation
   ...
   --  Start or restart one metadata annotation-table configuration
   --  replacement. Operation is last so overload resolution preserves the
   ...
   --  Construct one owner-driven metadata annotation-table configuration
   --  replacement.
   --  @param Set Caller-owned completion set
   --  @param Client HTTP client retained through terminal drain
   --  @param Origin Exact HTTP origin used for routing and signing
   ...
   --  @param Limits Caller-selected bounded XML limits
   --  @param Token Optional cancellation source retained to drain
   --  @return Started owner-driven metadata annotation-table configuration
   --  replacement
   function Set_Metadata_Annotation_Table_Configuration
     (Set        : not null access Flyology.Operations.Completion_Set'Class;
      Client     : not null access Flyology.HTTP.Client.Client;
      Origin     : Flyology.HTTP.Origin;
      Bucket     : String;
      ...
      Limits     : S3.XML.Parse_Limits;
      Token      : access Flyology.Cancellation.Token)
      return Set_Metadata_Annotation_Table_Configuration_Operation;

   --  Consume one terminal UpdateBucketMetadataAnnotationTableConfiguration
   --  operation.
   --  @param Operation Terminal owner-driven operation consumed
   --  @param Result Complete typed terminal evidence
   procedure Finish
     (Operation : in out Set_Metadata_Annotation_Table_Configuration_Operation;
      Result    : out Set_Metadata_Annotation_Table_Configuration_Result)
   with Pre => Flyology.Operations.Is_Terminal (Operation);

   --  Replace one metadata annotation-table configuration by waiting on the
   --  same state machine used by composable callers. No possibly admitted
   --  request is replayed; unknown outcomes require read-only
   --  Get_Metadata_Configuration reconciliation.
   --  @param Client HTTP client retained through terminal drain
   ...
   --  @param Token Caller-selected cancellation source or null
   --  @param Limits Caller-selected bounded XML limits
   --  @return Terminal typed metadata annotation-table configuration
   --  replacement evidence
   function Set_Metadata_Annotation_Table_Configuration
     (Client     : aliased in out Flyology.HTTP.Client.Client;
      Origin     : Flyology.HTTP.Origin;
   ...
   --  application
   --  @enum Bucket_ACL_Mutation_Outcome_Unknown Reconciliation is required
   --  @enum Bucket_ACL_Mutation_Cancelled_Before_Admission Cancelled before
   --  admission
   type Bucket_ACL_Mutation_Disposition is
     (Bucket_ACL_Mutation_Completed,
      Bucket_ACL_Mutation_Definitely_Not_Applied,
      Bucket_ACL_Mutation_Outcome_Unknown,
      Bucket_ACL_Mutation_Cancelled_Before_Admission);

   --  Shape of one terminal PutBucketAcl call.
   --  @enum Put_Bucket_ACL_Response_Available A complete modeled response
   --  exists
   --  @enum Put_Bucket_ACL_Exchange_Failed No complete modeled response exists
   type Put_Bucket_ACL_Result_Kind is
     (Put_Bucket_ACL_Response_Available,
      Put_Bucket_ACL_Exchange_Failed);

   --  Typed bucket access-control policy replacement result. The defaults are
   --  conservative initialization sentinels shared by sibling mutation
   --  results; Finish replaces them with terminal evidence before exposing the
   --  value.
   --  @field Kind Result shape
   ...
   --  @field HTTP_Phase Causal HTTP phase
   --  @field Detail Bounded sanitized HTTP diagnostic
   type Put_Bucket_ACL_Result
     (Kind : Put_Bucket_ACL_Result_Kind :=
        Put_Bucket_ACL_Exchange_Failed)
   is record
      Disposition : Bucket_ACL_Mutation_Disposition :=
        Bucket_ACL_Mutation_Outcome_Unknown;
      Failure : Failure_Reason := Corrupt_Or_Invalid_Response;
      Admission : Flyology.HTTP.Client.Admission_Certainty :=
        Flyology.HTTP.Client.Not_Admitted;
      case Kind is
         when Put_Bucket_ACL_Response_Available =>
            Response : Low_Level.Put_Bucket_Control_Outcome;
         when Put_Bucket_ACL_Exchange_Failed =>
            HTTP_Result : Flyology.HTTP.Client.Exchange_Result_Kind :=
              Flyology.HTTP.Client.Response_Invalid;
            HTTP_Phase : Flyology.HTTP.Client.Exchange_Phase :=
              Flyology.HTTP.Client.Not_Started;
   ...
   --  One-shot owner-driven bucket access-control policy replacement. The
   --  exact serialized body remains owned through typed Finish and is never
   --  replayed.
   type Put_Bucket_ACL_Operation
     (Set          : not null access Flyology.Operations.Completion_Set'Class;
      HTTP         : not null access Flyology.HTTP.Client.Client;
      Cancellation : access Flyology.Cancellation.Token) is
     new Flyology.Operations.Operation
   ...
   function Set_ACL
     (Set        : not null access Flyology.Operations.Completion_Set'Class;
      ...
      Limits     : S3.XML.Parse_Limits;
      Token      : access Flyology.Cancellation.Token)
      return Put_Bucket_ACL_Operation;

   --  Consume one terminal PutBucketAcl operation.
   --  @param Operation Terminal owner-driven operation consumed
   --  @param Result Complete typed terminal evidence
   procedure Finish
     (Operation : in out Put_Bucket_ACL_Operation;
      Result    : out Put_Bucket_ACL_Result)
   with Pre => Flyology.Operations.Is_Terminal (Operation);

   --  Replace one bucket access-control policy by waiting on the same state
   --  machine used by composable callers. No possibly admitted request is
   --  replayed; unknown outcomes require read-only Get_ACL reconciliation.
   --  @param Client HTTP client retained through terminal drain
   --  @param Origin Exact HTTP origin used for routing and signing
   --  @param Bucket Required exact target bucket
   --  @param Value Bucket access-control policy value serialized before
   ...
   --  @param Token Caller-selected cancellation source or null
   --  @param Limits Caller-selected bounded XML limits
   --  @return Terminal typed bucket access-control policy replacement evidence
   function Set_ACL
     (Client     : aliased in out Flyology.HTTP.Client.Client;
      Origin     : Flyology.HTTP.Origin;
      Bucket     : String;
   ...
   --  Shape of one terminal PutBucketInventoryConfiguration call.
   --  @enum Put_Bucket_Inventory_Configuration_Response_Available A complete
   --  modeled response exists
   --  @enum Put_Bucket_Inventory_Configuration_Exchange_Failed No complete
   --  modeled response exists
   type Put_Bucket_Inventory_Configuration_Result_Kind is
     (Put_Bucket_Inventory_Configuration_Response_Available,
      Put_Bucket_Inventory_Configuration_Exchange_Failed);

   --  Typed inventory configuration replacement result. The defaults are
   --  conservative initialization sentinels shared by sibling mutation
   --  results; Finish replaces them with terminal evidence before exposing the
   --  value.
   --  @field Kind Result shape
   ...
   --  @field HTTP_Phase Causal HTTP phase
   --  @field Detail Bounded sanitized HTTP diagnostic
   type Put_Bucket_Inventory_Configuration_Result
     (Kind : Put_Bucket_Inventory_Configuration_Result_Kind :=
        Put_Bucket_Inventory_Configuration_Exchange_Failed)
   is record
      Disposition : Bucket_Inventory_Configuration_Mutation_Disposition :=
        Bucket_Inventory_Configuration_Mutation_Outcome_Unknown;
      ...
      Admission : Flyology.HTTP.Client.Admission_Certainty :=
        Flyology.HTTP.Client.Not_Admitted;
      case Kind is
         when Put_Bucket_Inventory_Configuration_Response_Available =>
            Response : Low_Level.Put_Bucket_Control_Outcome;
         when Put_Bucket_Inventory_Configuration_Exchange_Failed =>
            HTTP_Result : Flyology.HTTP.Client.Exchange_Result_Kind :=
              Flyology.HTTP.Client.Response_Invalid;
            HTTP_Phase : Flyology.HTTP.Client.Exchange_Phase :=
              Flyology.HTTP.Client.Not_Started;
   ...
   --  One-shot owner-driven inventory configuration replacement. The exact
   --  serialized body remains owned through typed Finish and is never
   --  replayed.
   type Put_Bucket_Inventory_Configuration_Operation
     (Set          : not null access Flyology.Operations.Completion_Set'Class;
      HTTP         : not null access Flyology.HTTP.Client.Client;
      Cancellation : access Flyology.Cancellation.Token) is
     new Flyology.Operations.Operation
   ...
   procedure Set_Inventory_Configuration
     (Client     : not null access Flyology.HTTP.Client.Client;
      ...
      Limits     : S3.XML.Parse_Limits;
      Token      : access Flyology.Cancellation.Token;
      Operation  : in out Put_Bucket_Inventory_Configuration_Operation)
   with
     Pre =>
       not Flyology.Operations.Is_Active (Operation)
       and then not Flyology.Operations.Is_Terminal (Operation);
   ...
   function Set_Inventory_Configuration
     (Set        : not null access Flyology.Operations.Completion_Set'Class;
      ...
      Limits     : S3.XML.Parse_Limits;
      Token      : access Flyology.Cancellation.Token)
      return Put_Bucket_Inventory_Configuration_Operation;

   --  Consume one terminal PutBucketInventoryConfiguration operation.
   --  @param Operation Terminal owner-driven operation consumed
   --  @param Result Complete typed terminal evidence
   procedure Finish
     (Operation : in out Put_Bucket_Inventory_Configuration_Operation;
      Result    : out Put_Bucket_Inventory_Configuration_Result)
   with Pre => Flyology.Operations.Is_Terminal (Operation);

   --  Replace one inventory configuration by waiting on the same state machine
   --  used by composable callers. No possibly admitted request is replayed;
   --  unknown outcomes require read-only Get_Inventory_Configuration or
   --  List_Inventory_Configurations reconciliation.
   --  @param Client HTTP client retained through terminal drain
   --  @param Origin Exact HTTP origin used for routing and signing
   --  @param Bucket Required exact target bucket
   --  @param Value Inventory configuration value serialized before admission
   ...
   --  @param Token Caller-selected cancellation source or null
   --  @param Limits Caller-selected bounded XML limits
   --  @return Terminal typed inventory configuration replacement evidence
   function Set_Inventory_Configuration
     (Client     : aliased in out Flyology.HTTP.Client.Client;
      Origin     : Flyology.HTTP.Origin;
      Bucket     : String;
   ...
   --  What is known after terminal PutBucketLogging drain.
   --  @enum Bucket_Logging_Mutation_Completed Complete observed success
   --  @enum Bucket_Logging_Mutation_Definitely_Not_Applied Conclusive non-
   --  application
   --  @enum Bucket_Logging_Mutation_Outcome_Unknown Reconciliation is required
   --  @enum Bucket_Logging_Mutation_Cancelled_Before_Admission Cancelled
   --  before admission
   type Bucket_Logging_Mutation_Disposition is
     (Bucket_Logging_Mutation_Completed,
      Bucket_Logging_Mutation_Definitely_Not_Applied,
      Bucket_Logging_Mutation_Outcome_Unknown,
      Bucket_Logging_Mutation_Cancelled_Before_Admission);

   --  Shape of one terminal PutBucketLogging call.
   --  @enum Put_Bucket_Logging_Response_Available A complete modeled response
   --  exists
   --  @enum Put_Bucket_Logging_Exchange_Failed No complete modeled response
   --  exists
   type Put_Bucket_Logging_Result_Kind is
     (Put_Bucket_Logging_Response_Available,
      Put_Bucket_Logging_Exchange_Failed);

   --  Typed bucket logging configuration replacement result. The defaults are
   --  conservative initialization sentinels shared by sibling mutation
   --  results; Finish replaces them with terminal evidence before exposing the
   --  value.
   --  @field Kind Result shape
   ...
   --  @field HTTP_Phase Causal HTTP phase
   --  @field Detail Bounded sanitized HTTP diagnostic
   type Put_Bucket_Logging_Result
     (Kind : Put_Bucket_Logging_Result_Kind :=
        Put_Bucket_Logging_Exchange_Failed)
   is record
      Disposition : Bucket_Logging_Mutation_Disposition :=
        Bucket_Logging_Mutation_Outcome_Unknown;
      Failure : Failure_Reason := Corrupt_Or_Invalid_Response;
      Admission : Flyology.HTTP.Client.Admission_Certainty :=
        Flyology.HTTP.Client.Not_Admitted;
      case Kind is
         when Put_Bucket_Logging_Response_Available =>
            Response : Low_Level.Put_Bucket_Control_Outcome;
         when Put_Bucket_Logging_Exchange_Failed =>
            HTTP_Result : Flyology.HTTP.Client.Exchange_Result_Kind :=
              Flyology.HTTP.Client.Response_Invalid;
            HTTP_Phase : Flyology.HTTP.Client.Exchange_Phase :=
              Flyology.HTTP.Client.Not_Started;
   ...
   --  One-shot owner-driven bucket logging configuration replacement. The
   --  exact serialized body remains owned through typed Finish and is never
   --  replayed.
   type Put_Bucket_Logging_Operation
     (Set          : not null access Flyology.Operations.Completion_Set'Class;
      HTTP         : not null access Flyology.HTTP.Client.Client;
      Cancellation : access Flyology.Cancellation.Token) is
     new Flyology.Operations.Operation
   ...
   procedure Set_Logging
     (Client     : not null access Flyology.HTTP.Client.Client;
      ...
      Limits     : S3.XML.Parse_Limits;
      Token      : access Flyology.Cancellation.Token;
      Operation  : in out Put_Bucket_Logging_Operation)
   with
     Pre =>
       not Flyology.Operations.Is_Active (Operation)
       and then not Flyology.Operations.Is_Terminal (Operation);
   ...
   function Set_Logging
     (Set        : not null access Flyology.Operations.Completion_Set'Class;
      ...
      Limits     : S3.XML.Parse_Limits;
      Token      : access Flyology.Cancellation.Token)
      return Put_Bucket_Logging_Operation;

   --  Consume one terminal PutBucketLogging operation.
   --  @param Operation Terminal owner-driven operation consumed
   --  @param Result Complete typed terminal evidence
   procedure Finish
     (Operation : in out Put_Bucket_Logging_Operation;
      Result    : out Put_Bucket_Logging_Result)
   with Pre => Flyology.Operations.Is_Terminal (Operation);

   --  Replace one bucket logging configuration by waiting on the same state
   --  machine used by composable callers. No possibly admitted request is
   --  replayed; unknown outcomes require read-only Get_Logging reconciliation.
   --  @param Client HTTP client retained through terminal drain
   --  @param Origin Exact HTTP origin used for routing and signing
   --  @param Bucket Required exact target bucket
   --  @param Value Bucket logging configuration value serialized before
   ...
   --  @param Token Caller-selected cancellation source or null
   --  @param Limits Caller-selected bounded XML limits
   --  @return Terminal typed bucket logging configuration replacement evidence
   function Set_Logging
     (Client     : aliased in out Flyology.HTTP.Client.Client;
      Origin     : Flyology.HTTP.Origin;
      Bucket     : String;
   ...
   --  Shape of one terminal PutBucketWebsite call.
   --  @enum Put_Bucket_Website_Response_Available A complete modeled response
   --  exists
   --  @enum Put_Bucket_Website_Exchange_Failed No complete modeled response
   --  exists
   type Put_Bucket_Website_Result_Kind is
     (Put_Bucket_Website_Response_Available,
      Put_Bucket_Website_Exchange_Failed);

   --  Typed bucket website configuration replacement result. The defaults are
   --  conservative initialization sentinels shared by sibling mutation
   --  results; Finish replaces them with terminal evidence before exposing the
   --  value.
   --  @field Kind Result shape
   ...
   --  @field HTTP_Phase Causal HTTP phase
   --  @field Detail Bounded sanitized HTTP diagnostic
   type Put_Bucket_Website_Result
     (Kind : Put_Bucket_Website_Result_Kind :=
        Put_Bucket_Website_Exchange_Failed)
   is record
      Disposition : Bucket_Website_Mutation_Disposition :=
        Bucket_Website_Mutation_Outcome_Unknown;
      ...
      Admission : Flyology.HTTP.Client.Admission_Certainty :=
        Flyology.HTTP.Client.Not_Admitted;
      case Kind is
         when Put_Bucket_Website_Response_Available =>
            Response : Low_Level.Put_Bucket_Control_Outcome;
         when Put_Bucket_Website_Exchange_Failed =>
            HTTP_Result : Flyology.HTTP.Client.Exchange_Result_Kind :=
              Flyology.HTTP.Client.Response_Invalid;
            HTTP_Phase : Flyology.HTTP.Client.Exchange_Phase :=
              Flyology.HTTP.Client.Not_Started;
   ...
   --  One-shot owner-driven bucket website configuration replacement. The
   --  exact serialized body remains owned through typed Finish and is never
   --  replayed.
   type Put_Bucket_Website_Operation
     (Set          : not null access Flyology.Operations.Completion_Set'Class;
      HTTP         : not null access Flyology.HTTP.Client.Client;
      Cancellation : access Flyology.Cancellation.Token) is
     new Flyology.Operations.Operation
   ...
   procedure Set_Website
     (Client     : not null access Flyology.HTTP.Client.Client;
      ...
      Limits     : S3.XML.Parse_Limits;
      Token      : access Flyology.Cancellation.Token;
      Operation  : in out Put_Bucket_Website_Operation)
   with
     Pre =>
       not Flyology.Operations.Is_Active (Operation)
       and then not Flyology.Operations.Is_Terminal (Operation);
   ...
   function Set_Website
     (Set        : not null access Flyology.Operations.Completion_Set'Class;
      ...
      Limits     : S3.XML.Parse_Limits;
      Token      : access Flyology.Cancellation.Token)
      return Put_Bucket_Website_Operation;

   --  Consume one terminal PutBucketWebsite operation.
   --  @param Operation Terminal owner-driven operation consumed
   --  @param Result Complete typed terminal evidence
   procedure Finish
     (Operation : in out Put_Bucket_Website_Operation;
      Result    : out Put_Bucket_Website_Result)
   with Pre => Flyology.Operations.Is_Terminal (Operation);

   --  Replace one bucket website configuration by waiting on the same state
   --  machine used by composable callers. No possibly admitted request is
   --  replayed; unknown outcomes require read-only Get_Website reconciliation.
   --  @param Client HTTP client retained through terminal drain
   --  @param Origin Exact HTTP origin used for routing and signing
   --  @param Bucket Required exact target bucket
   --  @param Value Bucket website configuration value serialized before
   ...
   --  @param Token Caller-selected cancellation source or null
   --  @param Limits Caller-selected bounded XML limits
   --  @return Terminal typed bucket website configuration replacement evidence
   function Set_Website
     (Client     : aliased in out Flyology.HTTP.Client.Client;
      Origin     : Flyology.HTTP.Origin;
      Bucket     : String;
...
--  END S3 OPERATION GENERATOR: BUCKETS_VISIBLE

private

--  BEGIN S3 OPERATION GENERATOR: BUCKETS_PRIVATE
--  Generated by tools/s3-operation.py; do not edit this region.
   ...
   function Normalize_Create_Bucket_Metadata_Configuration_Failure
     (Kind      : Flyology.HTTP.Client.Exchange_Result_Kind;
      Admission : Flyology.HTTP.Client.Admission_Certainty;
      Phase     : Flyology.HTTP.Client.Exchange_Phase;
      Detail    : String) return Create_Bucket_Metadata_Configuration_Result;

   --  @exclude
   package Create_Bucket_Metadata_Configuration_Mutations is new
     Flyology.Object_Storage.Client.REST_XML_Mutations
       (Result_Type       => Create_Bucket_Metadata_Configuration_Result,
        Operation_Name    => "CreateBucketMetadataConfiguration",
        Start_Exchange    => Low_Level.Create_Bucket_Metadata_Configuration,
        Decode_Response   =>
          Decode_Create_Bucket_Metadata_Configuration_Family_Response,
        Normalize_Failure =>
          Normalize_Create_Bucket_Metadata_Configuration_Failure);
   ...
   type Create_Bucket_Metadata_Configuration_Operation
     ...
     and Flyology.HTTP.Client.Response_Body_Sink
   with record
      State : Create_Bucket_Metadata_Configuration_Mutations.State (Set);
   end record;
   ...
   --  @exclude
   package Set_Metadata_Inventory_Table_Configuration_Mutations is new
     Flyology.Object_Storage.Client.REST_XML_Mutations
       (Result_Type       => Set_Metadata_Inventory_Table_Configuration_Result,
        Operation_Name    => "UpdateBucketMetadataInventoryTableConfiguration",
        Start_Exchange    =>
          Low_Level.Set_Metadata_Inventory_Table_Configuration,
        Decode_Response   =>
          Decode_Set_Metadata_Inventory_Table_Configuration_Family_Response,
        Normalize_Failure =>
          Normalize_Set_Metadata_Inventory_Table_Configuration_Failure);
   ...
   type Set_Metadata_Inventory_Table_Configuration_Operation
     ...
     and Flyology.HTTP.Client.Response_Body_Sink
   with record
      State : Set_Metadata_Inventory_Table_Configuration_Mutations.State (Set);
   end record;
   ...
   --  @exclude
   package Set_Metadata_Annotation_Table_Configuration_Mutations is new
     Flyology.Object_Storage.Client.REST_XML_Mutations
       (Result_Type       =>
          Set_Metadata_Annotation_Table_Configuration_Result,
        Operation_Name    =>
          "UpdateBucketMetadataAnnotationTableConfiguration",
        Start_Exchange    =>
          Low_Level.Set_Metadata_Annotation_Table_Configuration,
        Decode_Response   =>
          Decode_Set_Metadata_Annotation_Table_Configuration_Family_Response,
        Normalize_Failure =>
          Normalize_Set_Metadata_Annotation_Table_Configuration_Failure);
   ...
   with record
      State :
        Set_Metadata_Annotation_Table_Configuration_Mutations.State (Set);
   end record;
   ...
   function Normalize_Put_Bucket_ACL_Failure
     (Kind      : Flyology.HTTP.Client.Exchange_Result_Kind;
      Admission : Flyology.HTTP.Client.Admission_Certainty;
      Phase     : Flyology.HTTP.Client.Exchange_Phase;
      Detail    : String) return Put_Bucket_ACL_Result;

   --  @exclude
   package Put_Bucket_ACL_Mutations is new
     Flyology.Object_Storage.Client.REST_XML_Mutations
       (Result_Type       => Put_Bucket_ACL_Result,
        Operation_Name    => "PutBucketAcl",
        Start_Exchange    => Low_Level.Put_Bucket_ACL,
        Decode_Response   =>
          Decode_Put_Bucket_ACL_Family_Response,
        Normalize_Failure =>
          Normalize_Put_Bucket_ACL_Failure);
   ...
   type Put_Bucket_ACL_Operation
     ...
     and Flyology.HTTP.Client.Response_Body_Sink
   with record
      State : Put_Bucket_ACL_Mutations.State (Set);
   end record;
   ...
   function Normalize_Put_Bucket_Inventory_Configuration_Failure
     (Kind      : Flyology.HTTP.Client.Exchange_Result_Kind;
      Admission : Flyology.HTTP.Client.Admission_Certainty;
      Phase     : Flyology.HTTP.Client.Exchange_Phase;
      Detail    : String) return Put_Bucket_Inventory_Configuration_Result;

   --  @exclude
   package Put_Bucket_Inventory_Configuration_Mutations is new
     Flyology.Object_Storage.Client.REST_XML_Mutations
       (Result_Type       => Put_Bucket_Inventory_Configuration_Result,
        Operation_Name    => "PutBucketInventoryConfiguration",
        Start_Exchange    => Low_Level.Put_Bucket_Inventory_Configuration,
        Decode_Response   =>
          Decode_Put_Bucket_Inventory_Configuration_Family_Response,
        Normalize_Failure =>
          Normalize_Put_Bucket_Inventory_Configuration_Failure);
   ...
   type Put_Bucket_Inventory_Configuration_Operation
     ...
     and Flyology.HTTP.Client.Response_Body_Sink
   with record
      State : Put_Bucket_Inventory_Configuration_Mutations.State (Set);
   end record;
   ...
   function Normalize_Put_Bucket_Logging_Failure
     (Kind      : Flyology.HTTP.Client.Exchange_Result_Kind;
      Admission : Flyology.HTTP.Client.Admission_Certainty;
      Phase     : Flyology.HTTP.Client.Exchange_Phase;
      Detail    : String) return Put_Bucket_Logging_Result;

   --  @exclude
   package Put_Bucket_Logging_Mutations is new
     Flyology.Object_Storage.Client.REST_XML_Mutations
       (Result_Type       => Put_Bucket_Logging_Result,
        Operation_Name    => "PutBucketLogging",
        Start_Exchange    => Low_Level.Put_Bucket_Logging,
        Decode_Response   =>
          Decode_Put_Bucket_Logging_Family_Response,
        Normalize_Failure =>
          Normalize_Put_Bucket_Logging_Failure);
   ...
   type Put_Bucket_Logging_Operation
     ...
     and Flyology.HTTP.Client.Response_Body_Sink
   with record
      State : Put_Bucket_Logging_Mutations.State (Set);
   end record;
   ...
   function Normalize_Put_Bucket_Website_Failure
     (Kind      : Flyology.HTTP.Client.Exchange_Result_Kind;
      Admission : Flyology.HTTP.Client.Admission_Certainty;
      Phase     : Flyology.HTTP.Client.Exchange_Phase;
      Detail    : String) return Put_Bucket_Website_Result;

   --  @exclude
   package Put_Bucket_Website_Mutations is new
     Flyology.Object_Storage.Client.REST_XML_Mutations
       (Result_Type       => Put_Bucket_Website_Result,
        Operation_Name    => "PutBucketWebsite",
        Start_Exchange    => Low_Level.Put_Bucket_Website,
        Decode_Response   =>
          Decode_Put_Bucket_Website_Family_Response,
        Normalize_Failure =>
          Normalize_Put_Bucket_Website_Failure);
   ...
   type Put_Bucket_Website_Operation
     ...
     and Flyology.HTTP.Client.Response_Body_Sink
   with record
      State : Put_Bucket_Website_Mutations.State (Set);
   end record;
...
--  END S3 OPERATION GENERATOR: BUCKETS_PRIVATE
   ...
   --  @exclude
   --  @param Item Owner-driven PutBucketTagging operation
   ...
   --  @exclude
   --  @param Limits Caller-selected XML parsing limits
   --  @return Effective GetBucketTagging response bound
   ...
   --  @exclude
   --  @param Item Owner-driven GetBucketTagging operation
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
   ...
   --  @exclude
   --  @param Item Owner-driven DeleteBucketTagging operation
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   --  @exclude
   --  @param Item Owner-driven ListBuckets operation
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
   ...
   overriding procedure Finalize
     (Item : in out List_Buckets_Operation);
   --  @exclude
   --  @param Item Owner-driven CreateBucket operation
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Create_Bucket_Operation);
   --  @exclude
   --  @param Item Owner-driven DeleteBucket operation
   --  @return Declared request-body length
   overriding
   ...
   --  @exclude
   --  @param Item Owner-driven Delete_Bucket_Operation state
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
     (Item : in out Delete_Bucket_Operation;
      Data : Ada.Streams.Stream_Element_Array);
   ...
   overriding procedure Finalize
     (Item : in out Delete_Bucket_Operation);
   --  @exclude
   --  @param Item Owner-driven Head_Bucket_Operation state
   --  @param Data Response-body slice required to be empty
   overriding procedure Write
   ...
   overriding procedure Finalize
     (Item : in out Head_Bucket_Operation);
   --  @exclude
   --  @param Item Owner-driven Get_Bucket_CORS_Operation state
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
   ...
   overriding procedure Finalize
     (Item : in out Get_Bucket_CORS_Operation);
   --  @exclude
   --  @param Item Owner-driven Delete_Bucket_CORS_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Delete_Bucket_CORS_Operation);
   --  @exclude
   --  @param Item Owner-driven Get_Object_Lock_Configuration_Operation state
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
   ...
   overriding procedure Finalize
     (Item : in out Get_Object_Lock_Configuration_Operation);
   --  @exclude
   --  @param Item Owner-driven Put_Object_Lock_Configuration_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Put_Object_Lock_Configuration_Operation);
   --  @exclude
   --  @param Item Owner-driven Get_Bucket_Encryption_Operation state
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
   ...
   overriding procedure Finalize
     (Item : in out Get_Bucket_Encryption_Operation);
   --  @exclude
   --  @param Item Owner-driven Get_Bucket_Lifecycle_Operation state
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
   ...
   overriding procedure Finalize
     (Item : in out Get_Bucket_Lifecycle_Operation);
   --  @exclude
   --  @param Item Owner-driven Get_Bucket_Replication_Operation state
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
   ...
   overriding procedure Finalize
     (Item : in out Get_Bucket_Replication_Operation);
   --  @exclude
   --  @param Item Owner-driven Put_Bucket_Replication_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Put_Bucket_Replication_Operation);
   --  @exclude
   --  @param Item Owner-driven Put_Bucket_Analytics_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Put_Bucket_Analytics_Operation);
   --  @exclude
   --  @param Item Owner-driven Put_Bucket_Intelligent_Tiering_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Put_Bucket_Intelligent_Tiering_Operation);
   --  @exclude
   --  @param Item Owner-driven Put_Bucket_Metrics_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Put_Bucket_Metrics_Operation);
   --  @exclude
   --  @param Item Owner-driven Get_Bucket_Notification_Operation state
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
   ...
   overriding procedure Finalize
     (Item : in out Get_Bucket_Notification_Operation);
   --  @exclude
   --  @param Item Owner-driven Get_Bucket_ACL_Operation state
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
   ...
   overriding procedure Finalize
     (Item : in out Get_Bucket_ACL_Operation);
   --  @exclude
   --  @param Item Owner-driven metadata-table read operation
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
   ...
   overriding procedure Finalize
     (Item : in out Get_Bucket_Metadata_Table_Configuration_Operation);
   --  @exclude
   --  @param Item Owner-driven metadata-table create operation
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Put_Bucket_Encryption_Operation);
   --  @exclude
   --  @param Item Owner-driven Delete_Bucket_Encryption_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Delete_Bucket_Encryption_Operation);
   --  @exclude
   --  @param Item Owner-driven Put_Bucket_Lifecycle_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Put_Bucket_Lifecycle_Operation);
   --  @exclude
   --  @param Item Owner-driven Put_Bucket_Notification_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Put_Bucket_Notification_Operation);
   --  @exclude
   --  @param Item Owner-driven Delete_Bucket_Lifecycle_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Delete_Bucket_Lifecycle_Operation);
   --  @exclude
   --  @param Item Owner-driven Delete_Bucket_Replication_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Delete_Bucket_Replication_Operation);
   --  @exclude
   --  @param Item Owner-driven Delete_Bucket_Website_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Delete_Bucket_Website_Operation);
   --  @exclude
   --  @param Item Owner-driven Delete_Bucket_Metadata_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   --  @exclude
   --  @param Item Owner-driven Delete_Bucket_Metadata_Table_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   --  @exclude
   --  @param Item Owner-driven Delete_Bucket_Metrics_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   --  @exclude
   --  @param Item Owner-driven Delete_Bucket_Analytics_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   --  @exclude
   --  @param Item Owner-driven Delete_Bucket_Tiering_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   --  @exclude
   --  @param Item Owner-driven inventory-delete operation
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Delete_Bucket_Inventory_Configuration_Operation);
   --  @exclude
   --  @param Item Owner-driven Get_Bucket_Ownership_Controls_Operation state
   --  @param Data Response bytes appended to the bounded payload
   overriding procedure Write
   ...
   overriding procedure Finalize
     (Item : in out Get_Bucket_Ownership_Controls_Operation);
   --  @exclude
   --  @param Item Owner-driven Put_Bucket_CORS_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
   ...
   overriding procedure Finalize
     (Item : in out Put_Bucket_CORS_Operation);
   --  @exclude
   --  @param Item Owner-driven Put_Bucket_Ownership_Controls_Operation state
   --  @return Declared request-body length
   overriding function Declared_Length
