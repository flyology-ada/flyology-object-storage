...
--  @exclude
--  Internal owner-driven state shared by bounded REST/XML read operations.
--  Provider packages retain request preparation, response decoding, and
--  modeled result classification; this family owns only transport-neutral
--  buffering, child lifetime, cancellation, drain, restart, and Finish.
