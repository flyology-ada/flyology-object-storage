...
--  Generated by tools/s3-operation.py; do not edit this region.
   ...
   begin
      return Prepare_Bucket_Control_Mutation
        (Model.Create_Bucket_Metadata_Configuration_Operation,
   ...
   exception
      when S3.Metadata_Configurations.Malformed_Metadata_Configuration =>
         raise Invalid_Request with
           "invalid CreateBucketMetadataConfiguration payload";
   end Prepare_Create_Bucket_Metadata_Configuration;
   ...
   begin
      ...
      Start_Source_Sink
        (Bucket_Control_Mutation_Operation, Client, Prepared, Source, Sink,
         Deadline, Token, Operation);
   end Create_Bucket_Metadata_Configuration;
   ...
   begin
      return Prepare_Bucket_Control_Mutation
        (Model.Update_Bucket_Metadata_Inventory_Table_Configuration_Operation,
   ...
   exception
      when S3.Metadata_Configurations.Malformed_Metadata_Configuration =>
         raise Invalid_Request with
           "invalid UpdateBucketMetadataInventoryTableConfiguration payload";
   end Prepare_Set_Metadata_Inventory_Table_Configuration;
   ...
   begin
      return Prepare_Bucket_Control_Mutation
        (Model.Update_Bucket_Metadata_Journal_Table_Configuration_Operation,
   ...
   exception
      when S3.Metadata_Configurations.Malformed_Metadata_Configuration =>
         raise Invalid_Request with
           "invalid UpdateBucketMetadataJournalTableConfiguration payload";
   end Prepare_Set_Metadata_Journal_Table_Configuration;
