...
package body Flyology.Object_Storage.Client.Paginated_REST_XML_Reads is
   ...
   procedure Start
     (Item             : in out State;
      ...
      Collection_Limit : Positive) is
   begin
      Item.Prepared := Prepared;
      Item.Deadline := Deadline;
      Item.Limits := Limits;
      Item.Collection_Limit := Collection_Limit;
      Flyology.Bytes.Clear (Item.Response_Data);
