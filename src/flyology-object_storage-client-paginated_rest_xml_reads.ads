...
--  @exclude
--  Internal owner-driven state shared by paginated REST/XML read operations.
--  Provider packages retain request preparation, response decoding, and
--  modeled result classification; this family owns only bounded buffering,
--  child lifetime, cancellation, drain, restart, and typed Finish.
