...
package body Flyology.Object_Storage.Client.Buckets is
   ...
   --  maintained GetBucketEncryption response corpus. The externally
   --  fixed ServerSideEncryptionConfigurationNotFoundError spelling is
   --  compatibility significant. This read-only classification authorizes
   --  no mutation or retry.
