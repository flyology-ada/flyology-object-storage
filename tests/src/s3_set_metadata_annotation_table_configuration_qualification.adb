...
procedure S3_Set_Metadata_Annotation_Table_Configuration_Qualification is
   ...
   use type Buckets.Set_Metadata_Annotation_Table_Configuration_Result_Kind;
   use type HTTP_Client.Exchange_Result_Kind;
   use type Low_Level.Put_Bucket_Control_Outcome_Kind;

   subtype Typed_Result is
     Buckets.Set_Metadata_Annotation_Table_Configuration_Result;
   subtype Typed_Result_Kind is
     Buckets.Set_Metadata_Annotation_Table_Configuration_Result_Kind;
   ...
   Available : constant Typed_Result_Kind :=
     Buckets.Set_Metadata_Annotation_Table_Configuration_Response_Available;
   Failed : constant Typed_Result_Kind :=
     Buckets.Set_Metadata_Annotation_Table_Configuration_Exchange_Failed;
   ...
   Value : constant Metadata_Configurations.Annotation_Table_Configuration :=
     (Is_Set              => True,
      Configuration_State => Metadata_Configurations.Annotation_Enabled,
   ...
   begin
      declare
         Unexpected : constant Low_Level.Put_Bucket_Control_Outcome :=
           Low_Level.Execute_Set_Metadata_Annotation_Table_Configuration
   ...
   if Lane = "low_level" then
      ...
      declare
         Prepared : constant Low_Level.Prepared_Request :=
           Low_Level.Prepare_Set_Metadata_Annotation_Table_Configuration
      ...
      Check_Result
        (Buckets.Set_Metadata_Annotation_Table_Configuration
...
exception
   when others =>
      HTTP_Client.Shutdown (HTTP);
      raise;
end S3_Set_Metadata_Annotation_Table_Configuration_Qualification;
