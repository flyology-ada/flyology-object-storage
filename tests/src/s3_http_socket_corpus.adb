      ...
      for Round in 1 .. 2 loop
         ...
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            ...
            Expected_Bucket_Owner => "123456789012");
         --  Pinned analytics fixtures preserve the shared reference
         --  owner, exact 204/403 outcomes, and the 256-byte oversized error
         --  payload paired with the client-selected 64-byte limit below.
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            "/typed-delete-analytics?analytics&id=config%20id",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            "/composed-delete-analytics?analytics&id=config%20id",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("403 Forbidden", Error_XML,
               "x-amz-request-id: restarted-delete-analytics" & CRLF),
            "DELETE",
            "/restart-delete-analytics?analytics&id=config%20id",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("204 No Content", "",
               "x-amz-request-id: duplicate-analytics" & CRLF &
               "x-amz-request-id: duplicate-analytics" & CRLF),
            "DELETE",
            "/invalid-delete-analytics?analytics&id=config%20id",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response ("204 No Content", "", "x-amz-id-2: " & CRLF),
            "DELETE",
            "/empty-host-delete-analytics?analytics&id=config%20id",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("500 Internal Server Error",
               ...
               String'(1 .. 256 => 'x') & "</Message></Error>"),
            "DELETE",
            "/bounded-delete-analytics?analytics&id=config%20id",
            Expected_Bucket_Owner => "123456789012");
         ...
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            "/typed-delete-inventory?id=config%20id&inventory",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            "/composed-delete-inventory?id=config%20id&inventory",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("403 Forbidden", Error_XML,
               "x-amz-request-id: restarted-delete-inventory" & CRLF),
            "DELETE", "/restart-delete-inventory?id=config%20id&inventory",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("204 No Content", "",
               "x-amz-request-id: duplicate-inventory" & CRLF &
               "x-amz-request-id: duplicate-inventory" & CRLF),
            "DELETE", "/invalid-delete-inventory?id=config%20id&inventory",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("204 No Content", "", "x-amz-id-2: " & CRLF),
            "DELETE", "/empty-host-delete-inventory?id=config%20id&inventory",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("500 Internal Server Error",
               "<Error><Code>InternalError</Code><Message>" &
               String'(1 .. 256 => 'x') & "</Message></Error>"),
            "DELETE", "/bounded-delete-inventory?id=config%20id&inventory",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
         ...
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            ...
            Expected_Bucket_Owner => "123456789012");
         --  Pinned metadata fixtures preserve the shared reference
         --  owner, exact 204/403 outcomes, and the 256-byte oversized error
         --  payload paired with the client-selected 64-byte limit below.
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            "/typed-delete-metadata?metadataConfiguration",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            "/composed-delete-metadata?metadataConfiguration",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("403 Forbidden", Error_XML,
               "x-amz-request-id: restarted-delete-metadata" & CRLF),
            "DELETE",
            "/restart-delete-metadata?metadataConfiguration",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("204 No Content", "",
               "x-amz-request-id: duplicate-metadata" & CRLF &
               "x-amz-request-id: duplicate-metadata" & CRLF),
            "DELETE",
            "/invalid-delete-metadata?metadataConfiguration",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response ("204 No Content", "", "x-amz-id-2: " & CRLF),
            "DELETE",
            "/empty-host-delete-metadata?metadataConfiguration",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("500 Internal Server Error",
         ...
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            ...
            Expected_Bucket_Owner => "123456789012");
         --  Pinned metrics fixtures preserve the shared reference
         --  owner, exact 204/403 outcomes, and the 256-byte oversized error
         --  payload paired with the client-selected 64-byte limit below.
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
         ...
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            "/composed-delete-metrics?id=config%20id&metrics",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("403 Forbidden", Error_XML,
               "x-amz-request-id: restarted-delete-metrics" & CRLF),
            "DELETE",
            "/restart-delete-metrics?id=config%20id&metrics",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("204 No Content", "",
               "x-amz-request-id: duplicate-metrics" & CRLF &
               "x-amz-request-id: duplicate-metrics" & CRLF),
            "DELETE",
            "/invalid-delete-metrics?id=config%20id&metrics",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response ("204 No Content", "", "x-amz-id-2: " & CRLF),
            "DELETE",
            "/empty-host-delete-metrics?id=config%20id&metrics",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("500 Internal Server Error",
               ...
               String'(1 .. 256 => 'x') & "</Message></Error>"),
            "DELETE",
            "/bounded-delete-metrics?id=config%20id&metrics",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
         ...
         Serve
           (HTTP_Response
            ...
            Expected_Bucket_Owner => "123456789012");
         --  Pinned replication fixtures preserve the shared reference owner,
         --  exact 204/403 outcomes, and the 256-byte oversized error payload
         --  paired with the client-selected 64-byte limit below.
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
         ...
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            "/typed-delete-replication?replication",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response ("204 No Content", ""), "DELETE",
            "/composed-delete-replication?replication",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("403 Forbidden", Error_XML,
               "x-amz-request-id: restarted-delete-replication" & CRLF),
            "DELETE", "/restart-delete-replication?replication",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("204 No Content", "",
               "x-amz-request-id: duplicate-replication" & CRLF &
               "x-amz-request-id: duplicate-replication" & CRLF),
            "DELETE", "/invalid-delete-replication?replication",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("204 No Content", "", "x-amz-id-2: " & CRLF),
            "DELETE", "/empty-host-delete-replication?replication",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("500 Internal Server Error",
         ...
         Serve
           (HTTP_Response
              ("200 OK", "<AccessControlPolicy><Owner><ID>typed-owner" &
                 "</ID></Owner><AccessControlList/></AccessControlPolicy>",
               "x-amz-request-id: typed-acl" & CRLF),
            "GET", "/typed-bucket-acl?acl",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response ("200 OK", ""),
            "GET", "/composed-bucket-acl?acl",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("403 Forbidden", Error_XML,
               "x-amz-request-id: restarted-bucket-acl" & CRLF),
            "GET", "/restart-bucket-acl?acl",
            Expected_Bucket_Owner => "123456789012");
         Serve
           (HTTP_Response
              ("200 OK", "<AccessControlPolicy/>",
   ...
   begin
      ...
      begin
         ...
         declare
            ...
            --  Parent, HTTP exchange, and HTTP's one active transport child.
            Set : aliased Operations.Completion_Set (3);
            Parent : aliased Delete_Bucket_Analytics_Operation
              (Set'Access, HTTP'Access, null);
            Child : HTTP_Client.Exchange_Operation (Set'Access);
            Rejected : Boolean := False;
         ...
         begin
            ...
            begin
               Low_Level.Delete_Bucket_Analytics_Configuration
                 (HTTP'Access,
                  Prepared'Access,
                  Parent'Access,
                  Parent'Access,
            ...
            begin
               ...
               then
                  raise Program_Error with
                    "bounded DeleteBucketAnalyticsConfiguration " &
                    "response " &
                    "mismatch";
               end if;
            end;
         ...
         declare
            ...
            --  Parent, HTTP exchange, and HTTP's one active transport child.
            Set : aliased Operations.Completion_Set (3);
            Parent : aliased Delete_Bucket_Inventory_Configuration_Operation
              (Set'Access, HTTP'Access, null);
            Child : HTTP_Client.Exchange_Operation (Set'Access);
            Rejected : Boolean := False;
         ...
         begin
            ...
            begin
               Low_Level.Delete_Bucket_Inventory_Configuration
                 (HTTP'Access,
                  Prepared'Access,
                  Parent'Access,
                  Parent'Access,
            ...
            begin
               ...
               then
                  raise Program_Error with
                    "DeleteBucketInventoryConfiguration accepted duplicate " &
                    "response " &
                    "identifier";
               end if;
               Delete_Inventory_Configuration
               ...
               then
                  raise Program_Error with
                    "DeleteBucketInventoryConfiguration accepted an empty " &
                    "host " &
                    "identifier";
               end if;
               Delete_Inventory_Configuration
         ...
         declare
            ...
            --  Parent, HTTP exchange, and HTTP's one active transport child.
            Set : aliased Operations.Completion_Set (3);
            Parent : aliased Delete_Bucket_Metadata_Operation
              (Set'Access, HTTP'Access, null);
            Child : HTTP_Client.Exchange_Operation (Set'Access);
            Rejected : Boolean := False;
         ...
         begin
            ...
            begin
               Low_Level.Delete_Bucket_Metadata_Configuration
                 (HTTP'Access,
                  Prepared'Access,
                  Parent'Access,
                  Parent'Access,
         ...
         declare
            ...
            --  Parent, HTTP exchange, and HTTP's one active transport child.
            Set : aliased Operations.Completion_Set (3);
            Parent : aliased Delete_Bucket_Metrics_Operation
              (Set'Access, HTTP'Access, null);
            Child : HTTP_Client.Exchange_Operation (Set'Access);
            Rejected : Boolean := False;
         ...
         begin
            ...
            begin
               Low_Level.Delete_Bucket_Metrics_Configuration
                 (HTTP'Access,
                  Prepared'Access,
                  Parent'Access,
                  Parent'Access,
         ...
         declare
            ...
            Parameters :
              Low_Level.Delete_Bucket_Configuration_Parameters :=
                (Expected_Bucket_Owner =>
                   US.To_Unbounded_String ("123456789012"));
            Prepared : aliased Low_Level.Prepared_Request :=
              Low_Level.Prepare_Delete_Bucket_Website
                (Origin,
                 Low_Level.Path_Style,
                 "example-bucket",
                 Parameters,
            ...
            --  Parent, HTTP exchange, and HTTP's one active transport child.
            Set : aliased Operations.Completion_Set (3);
            Parent : aliased Delete_Bucket_Replication_Operation
              (Set'Access, HTTP'Access, null);
            Child : HTTP_Client.Exchange_Operation (Set'Access);
            Rejected : Boolean := False;
         ...
         begin
            declare
               Typed_Result : constant Delete_Bucket_Replication_Result :=
                 Buckets.Delete_Replication
                   (HTTP,
                    Origin,
                    "typed-delete-replication",
                    Parameters,
                    Identity,
                    Timeout => 5.0);
            begin
            ...
            begin
               Low_Level.Delete_Bucket_Replication
                 (HTTP'Access,
                  Prepared'Access,
                  Parent'Access,
                  Parent'Access,
            ...
            begin
               ...
               then
                  raise Program_Error with
                    "DeleteBucketReplication accepted duplicate response " &
                    "identifier";
               end if;
               Delete_Replication
                 (HTTP'Access,
                  Origin,
                  "empty-host-delete-replication",
                  Parameters,
                  Identity,
                  HTTP_Client.Deadline_After (5.0),
                  Operation => Operation);
               ...
               then
                  raise Program_Error with
                    "DeleteBucketReplication accepted an empty host " &
                    "identifier";
               end if;
               Delete_Replication
                 (HTTP'Access,
                  Origin,
                  "bounded-delete-replication",
                  Parameters,
                  Identity,
                  HTTP_Client.Deadline_After (5.0),
                  Limits =>
               ...
               then
                  raise Program_Error with
                    "bounded DeleteBucketReplication response mismatch";
               end if;
            end;
         end;
         Require_Configuration_Deletion
            ...
            Prepared : aliased Low_Level.Prepared_Request :=
              Low_Level.Prepare_Get_Bucket_Encryption
                (Origin, Low_Level.Path_Style, "example-bucket",
                 ...
                 "20130524T000000Z");
            Set : aliased Operations.Completion_Set (3);
            Parent : aliased Get_Bucket_ACL_Operation
              (Set'Access, HTTP'Access, null);
            Child : HTTP_Client.Exchange_Operation (Set'Access);
            Rejected : Boolean := False;
         begin
            begin
               Low_Level.Get_Bucket_ACL
                 (HTTP'Access,
                  Prepared'Access,
                  Parent'Access,
                  HTTP_Client.Deadline_After (5.0),
            ...
            if not Rejected then
               raise Program_Error with
                 "GetBucketAcl accepted an encryption request";
            end if;
         end;
         declare
            Parameters : constant Low_Level.Get_Bucket_Control_Parameters :=
            ...
            Result : constant Get_Bucket_ACL_Result :=
              Buckets.Get_ACL
                (HTTP, Origin, "typed-bucket-acl", Parameters, Identity,
                 Timeout => 5.0);
         begin
            if Result.Kind /= Get_Bucket_ACL_Response_Available
              ...
              or else Result.Admission /= HTTP_Client.Response_Observed
              or else Result.Response.Kind /= Low_Level.Bucket_Control_Found
              or else not Result.Response.Policy.Is_Set
              or else not Result.Response.Policy.Policy_Owner.Is_Set
              or else US.To_String
                (Result.Response.Policy.Policy_Owner.ID.Value) /= "typed-owner"
            then
               raise Program_Error with
                 "typed GetBucketAcl response mismatch";
            end if;
         end;
         declare
            Parameters : constant Low_Level.Get_Bucket_Control_Parameters :=
         ...
         begin
            ...
            begin
               ...
               if Result.Kind /= Get_Bucket_ACL_Response_Available
                 ...
                 or else Result.Response.Kind /=
                   Low_Level.Bucket_Control_Found
                 or else Result.Response.Policy.Is_Set
               then
                  raise Program_Error with
                    "composed GetBucketAcl first result mismatch";
               end if;
               Get_ACL
                 (HTTP'Access,
                  Origin,
               ...
               if Result.Kind /= Get_Bucket_ACL_Response_Available
                 ...
                 or else Result.Response.Kind /=
                   Low_Level.Get_Bucket_Control_Rejected
                 or else US.To_String (Result.Response.Error.Request_ID) /=
                   "restarted-bucket-acl"
               then
                  raise Program_Error with
                    "composed GetBucketAcl restart mismatch";
               end if;
            end;
         end;
         declare
            ...
            Result : constant Get_Bucket_ACL_Result :=
              Buckets.Get_ACL
                (HTTP, Origin, "duplicate-bucket-acl-header", Parameters,
                 Identity, Timeout => 5.0);
         begin
            ...
            then
               raise Program_Error with
                 "duplicate GetBucketAcl response header admitted";
            end if;
         end;
         declare
            Parameters : constant Low_Level.Get_Bucket_Control_Parameters :=
            ...
            Result : constant Get_Bucket_ACL_Result :=
              Buckets.Get_ACL
                (HTTP, Origin, "bounded-bucket-acl", Parameters, Identity,
                 Timeout => 5.0,
                 Limits =>
         ...
         begin
            ...
            then
               raise Program_Error with
                 "GetBucketAcl response limit was not enforced";
            end if;
         end;
         declare
            Prepared : constant Low_Level.Prepared_Request :=
