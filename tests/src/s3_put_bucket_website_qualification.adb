...
procedure S3_Put_Bucket_Website_Qualification is
   ...
   use type Buckets.Bucket_Website_Mutation_Disposition;
   use type Buckets.Put_Bucket_Website_Result_Kind;
   use type HTTP_Client.Exchange_Result_Kind;
   use type Low_Level.Put_Bucket_Control_Outcome_Kind;

   subtype Typed_Result is
     Buckets.Put_Bucket_Website_Result;
   subtype Typed_Result_Kind is
     Buckets.Put_Bucket_Website_Result_Kind;
   subtype Typed_Disposition is
     Buckets.Bucket_Website_Mutation_Disposition;
   Available : constant Typed_Result_Kind :=
     Buckets.Put_Bucket_Website_Response_Available;
   Failed : constant Typed_Result_Kind :=
     Buckets.Put_Bucket_Website_Exchange_Failed;
   Completed : constant Typed_Disposition :=
     Buckets.Bucket_Website_Mutation_Completed;
   Definitely_Not_Applied : constant Typed_Disposition :=
     Buckets.Bucket_Website_Mutation_Definitely_Not_Applied;
   Outcome_Unknown : constant Typed_Disposition :=
     Buckets.Bucket_Website_Mutation_Outcome_Unknown;
   ...
   Value : constant Website.Website_Configuration :=
     Website.Parse (Document, Limits);
   ...
   begin
      declare
         Unexpected : constant Low_Level.Put_Bucket_Control_Outcome :=
           Low_Level.Execute_Put_Bucket_Website
...
begin
   ...
   if Lane = "low_level" then
      ...
      declare
         Prepared : constant Low_Level.Prepared_Request :=
           Low_Level.Prepare_Put_Bucket_Website
      ...
      declare
         ...
         Operation : Buckets.Put_Bucket_Website_Operation :=
           Buckets.Set_Website
   ...
   Ada.Text_IO.Put_Line
     ("PutBucketWebsite signed qualification " &
      Case_ID & ": OK");
exception
   when others =>
      HTTP_Client.Shutdown (HTTP);
      raise;
end S3_Put_Bucket_Website_Qualification;
