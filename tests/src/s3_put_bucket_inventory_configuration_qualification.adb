...
procedure S3_Put_Bucket_Inventory_Configuration_Qualification is
   ...
   use type Buckets.Bucket_Inventory_Configuration_Mutation_Disposition;
   use type Buckets.Put_Bucket_Inventory_Configuration_Result_Kind;
   use type HTTP_Client.Exchange_Result_Kind;
   use type Low_Level.Put_Bucket_Control_Outcome_Kind;

   subtype Typed_Result is
     Buckets.Put_Bucket_Inventory_Configuration_Result;
   subtype Typed_Result_Kind is
     Buckets.Put_Bucket_Inventory_Configuration_Result_Kind;
   subtype Typed_Disposition is
     Buckets.Bucket_Inventory_Configuration_Mutation_Disposition;
   Available : constant Typed_Result_Kind :=
     Buckets.Put_Bucket_Inventory_Configuration_Response_Available;
   Failed : constant Typed_Result_Kind :=
     Buckets.Put_Bucket_Inventory_Configuration_Exchange_Failed;
   Completed : constant Typed_Disposition :=
     Buckets.Bucket_Inventory_Configuration_Mutation_Completed;
   Definitely_Not_Applied : constant Typed_Disposition :=
     Buckets.Bucket_Inventory_Configuration_Mutation_Definitely_Not_Applied;
   Outcome_Unknown : constant Typed_Disposition :=
     Buckets.Bucket_Inventory_Configuration_Mutation_Outcome_Unknown;
   ...
   Parameters : constant
     Low_Level.Put_Bucket_Inventory_Configuration_Parameters :=
   ...
   Document : constant String :=
     "<InventoryConfiguration xmlns=""http://s3.amazonaws.com/doc/" &
   ...
   Value : constant Inventory.Inventory_Configuration :=
     Inventory.Parse (Document, Limits);
   ...
   begin
      declare
         Unexpected : constant Low_Level.Put_Bucket_Control_Outcome :=
           Low_Level.Execute_Put_Bucket_Inventory_Configuration
...
begin
   ...
   if Lane = "low_level" then
      ...
      declare
         Prepared : constant Low_Level.Prepared_Request :=
           Low_Level.Prepare_Put_Bucket_Inventory_Configuration
      ...
      Check_Result
        (Buckets.Set_Inventory_Configuration
      ...
      declare
         ...
         Operation : Buckets.Put_Bucket_Inventory_Configuration_Operation :=
           Buckets.Set_Inventory_Configuration
   ...
   Ada.Text_IO.Put_Line
     ("PutBucketInventoryConfiguration signed qualification " &
      Case_ID & ": OK");
exception
   when others =>
      HTTP_Client.Shutdown (HTTP);
      raise;
end S3_Put_Bucket_Inventory_Configuration_Qualification;
