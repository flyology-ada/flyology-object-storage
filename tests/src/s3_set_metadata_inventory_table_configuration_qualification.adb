...
procedure S3_Set_Metadata_Inventory_Table_Configuration_Qualification is
   ...
   use type Buckets.Set_Metadata_Inventory_Table_Configuration_Result_Kind;
   use type HTTP_Client.Exchange_Result_Kind;
   use type Low_Level.Put_Bucket_Control_Outcome_Kind;

   subtype Typed_Result is
     Buckets.Set_Metadata_Inventory_Table_Configuration_Result;
   subtype Typed_Result_Kind is
     Buckets.Set_Metadata_Inventory_Table_Configuration_Result_Kind;
   ...
   Available : constant Typed_Result_Kind :=
     Buckets.Set_Metadata_Inventory_Table_Configuration_Response_Available;
   Failed : constant Typed_Result_Kind :=
     Buckets.Set_Metadata_Inventory_Table_Configuration_Exchange_Failed;
   ...
   Value : constant Metadata_Configurations.Inventory_Table_Configuration :=
     (Is_Set              => True,
   ...
   begin
      declare
         Unexpected : constant Low_Level.Put_Bucket_Control_Outcome :=
           Low_Level.Execute_Set_Metadata_Inventory_Table_Configuration
...
begin
   ...
   if Lane = "low_level" then
      ...
      Check_Result
        (Buckets.Set_Metadata_Inventory_Table_Configuration
   ...
   Ada.Text_IO.Put_Line
     ("UpdateBucketMetadataInventoryTableConfiguration signed qualification " &
      Case_ID & ": OK");
exception
   when others =>
      HTTP_Client.Shutdown (HTTP);
      raise;
end S3_Set_Metadata_Inventory_Table_Configuration_Qualification;
