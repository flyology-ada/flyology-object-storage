...
procedure S3_Create_Bucket_Metadata_Configuration_Qualification is
   ...
   use type Buckets.Create_Bucket_Metadata_Configuration_Result_Kind;
   use type HTTP_Client.Exchange_Result_Kind;
   use type Low_Level.Put_Bucket_Control_Outcome_Kind;

   subtype Typed_Result is
     Buckets.Create_Bucket_Metadata_Configuration_Result;
   subtype Typed_Result_Kind is
     Buckets.Create_Bucket_Metadata_Configuration_Result_Kind;
   ...
   Available : constant Typed_Result_Kind :=
     Buckets.Create_Bucket_Metadata_Configuration_Response_Available;
   Failed : constant Typed_Result_Kind :=
     Buckets.Create_Bucket_Metadata_Configuration_Exchange_Failed;
   ...
   Parameters : constant Low_Level.Bucket_Control_Mutation_Parameters :=
   ...
   Value : constant Metadata_Configurations.Metadata_Configuration_Request :=
     (Journal =>
        (Expiration =>
      ...
      Inventory =>
        (Is_Set => True,
         Configuration_State => Metadata_Configurations.Inventory_Enabled,
         Encryption => (Is_Set => False, others => <>)),
      Annotation =>
        (Is_Set => True,
         Configuration_State => Metadata_Configurations.Annotation_Disabled,
         Encryption => (Is_Set => False, others => <>),
         Role =>
           (Is_Set => True,
   ...
   begin
      declare
         Unexpected : constant Low_Level.Put_Bucket_Control_Outcome :=
           Low_Level.Execute_Create_Bucket_Metadata_Configuration
...
begin
   ...
   if Lane = "low_level" then
      ...
      Check_Result
        (Buckets.Create_Metadata_Configuration
      ...
      declare
         ...
         Operation : Buckets.Create_Bucket_Metadata_Configuration_Operation :=
           Buckets.Create_Metadata_Configuration
   ...
   Ada.Text_IO.Put_Line
     ("CreateBucketMetadataConfiguration signed qualification " &
      Case_ID & ": OK");
exception
   when others =>
      HTTP_Client.Shutdown (HTTP);
      raise;
end S3_Create_Bucket_Metadata_Configuration_Qualification;
